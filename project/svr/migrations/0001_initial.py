...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('coffee', models.CharField(max_length=100, verbose_name='Выберите кофе')),
                ('coffee_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Цена кофе')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('desert', models.CharField(max_length=100, verbose_name='Выберите десерт')),
                ('desert_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Цена десерта')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('coffee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coffee_order', to='svr.coffee')),
                ...
                ('desert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desert_order', to='svr.desert')),
            ],
        ),
    ]
