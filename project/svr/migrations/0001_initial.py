# Generated by Django 4.1.4 on 2022-12-15 20:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qty', models.IntegerField(default=1, verbose_name='Колличество')),
            ],
        ),
        migrations.CreateModel(
            name='Position',
        ...
        migrations.AddField(
            model_name='extra',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='svr.order', verbose_name='Заказчик'),
        ),
        migrations.AddField(
            model_name='extra',
            name='position',
